  ...
  const navigate = useNavigate();
    ...
    return(
        <div className="registerContainer">
            <Logo/>
            <Form handleSignUp = {handleUserSignup} email={email} setEmail={setEmail} password={password} setPassword={setPassword}/>
        </div>
    );
}
function Logo(){
...
function Form({handleSignUp , email , setEmail , password  , setPassword}){
    ...
    return (
        <div className="registerForm">
            ...
            <h3 className="loginText">Already have an account ? Log in</h3>
        </div>
    );
}
